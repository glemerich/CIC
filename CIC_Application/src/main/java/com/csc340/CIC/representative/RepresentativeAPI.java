...
public class RepresentativeAPI {
    ...
    public RepresentativeAPI(String id, String title, String firstName, String lastName, String party, String leadershipRole, String nextElection, String chamber, String url) {
        this.id = id;
        this.title = title;
